...
def market_period_result(symbol,start_date,end_date,std,window,sl_long,sl_short,cc_long,cc_short):
    ...
    bb_std_dev = std
    bb_window = window
    SL_PERCENT_lONG = sl_long
    SL_PERCENT_SHORT = sl_short
    CANDLE_COUNT_LONG = cc_long
    CANDLE_COUNT_SHORT = cc_short
